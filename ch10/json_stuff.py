...
print(
    "Enter some usernames and I will store them as JSON objects in a file"
    " (press 'q' to quit)"
)
while True:
    add_user = input("Name? => ")
    if add_user == "q":
        ...
        print(
            f"Thanks for that info. We'll remember you when you come back {add_user}"
        )
...
if len(usernames) == 0:
    ...
    chosen_file = input(
        "Now, enter a filename to dump the usernames you've provided: "
    )
