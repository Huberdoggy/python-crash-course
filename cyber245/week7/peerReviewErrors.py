...
def chooseCave():
    cave = ''
    while cave != '1' and cave != '2':  # Issue with indentation fixed to reflect PEP8 tab=4 spaces standard
...
def checkCave(chosenCave):
    ...
    if chosenCave == str(friendlyCave):
        ...
        print('Gobbles you down in one bite!')  # Fixed - added parentheses around print function
