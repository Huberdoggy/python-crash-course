...
from cars_and_trucks import (
    screen_clear as s_c,
    format_main_menu as fmm,
    show_garage,
    get_vehicle_attribs as get_attribs,
    Car,
    Truck,
)
...
opts_lst = [
    ...
    "Show Garage",
    "Quit",
]  # To pass to 'mm' as main menu opts
    ...
    while show_menu:
        ...
        if num_choice in range(1, 5):
            if num_choice == 1:  # For car creation
                ...
                print(
                    f"You will now be directed to {color_choice} specific questions..."
                )
                sleep(3)
                s_c()
                check_done = False
                while not check_done:
                    new_car = Car()
                    vroom = input(
                        f"Your new {new_car.make.title()} {new_car.model.title()} "
                    ...
                    if vroom == "y":
                        ...
                        print_red(
                            f"Discarded the {new_car.model.title()}. But, you must add at least 1"
                            f" car to the garage."
                        )
                    else:
                ...
                while not check_done:
                    ...
                    if vroom == "y":
                        ...
                        print_red(
                            f"Discarded the {new_truck.model.title()}. But, you must add at least 1"
