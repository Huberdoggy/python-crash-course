...
from cli_functions import (
    compile_patterns as c_p,
)  # From my sister directory for the OpenWeather functions
...
beginning_sub = error_msg[
    :10
]  # Going to play with something new for this program - substring concat
...
while go_again:
    num_miles = input(
        "Please enter the total number of miles you've driven (or 'q' to quit) => "
    )
    if num_miles == "q":
        break
